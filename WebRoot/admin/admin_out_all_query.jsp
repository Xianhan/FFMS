	...
	<div id="box">
		<div id="pos">
			<!--
                ...
                -->
			<div id="top">
				<form action="../OutGroupByType" method="post">
					查询<input type="date" name="startDate"
						value="${sessionScope.startdate}">至<input type="date"
						name="endDate" value="${sessionScope.enddate}">的支出信息<input
						type="submit" value="查询">
						<a href="../WriteFamilyOutAction">导出</a>
				</form>
			</div>
			<!--
                	下部分显示
			...
			<div id="down">
				...
				<div id="left">
					<table class="tab">
						...
						<c:forEach items="${sessionScope.outGroupByList}" var="og">
							<tr>
								<td class="td">${og.ioType }</td>
								<td class="td">${og.allOutMoney }</td>
							</tr>
						</c:forEach>
					</table>
					<span id="json" hidden="hidden">${sessionScope.json}</span>
				</div>
				<!--
                    	右部分显示圆形图
                    -->
